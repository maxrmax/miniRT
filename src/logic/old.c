...
If not → it’s lit,
	and you compute the brightness based on light angle and surface normal.
...
You only cast rays from the camera, but at each hit point,
	you query light visibility.
