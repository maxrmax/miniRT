...
/*   Updated: 2025/12/05 15:51:38 by mring            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "miniRT.h"

void	light_calc(t_rt *scene) // may need to change to hit_obj
{
	t_obj *shadow_obj;
	double shadow_t;

	shadow_obj = scene->hit_obj;
	...
	while (shadow_obj)
	{
		// Setup shadow ray on the object being tested
